...
namespace suplex {
    ...
    void Renderer::BakeEnvironmentLight()
    {
        ...
        m_PrecomputeContext->HDR_EnvironmentTexture.LoadData("../Assets/EnvironmentMap/SunlessCirruscover4k.hdr",
        ...
        m_PrecomputeContext->Emu_BRDF_LUT.Allocate(512, 512);
        ...
        m_PrecomputePass->PushShader(std::make_shared<Shader>("brdf_integration.vert", "emu_integration.frag"));
